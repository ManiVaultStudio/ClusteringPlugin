...
class ClusteringPluginConan(ConanFile):
    """Class to package the ClusteringPlugin plugin using conan
    ...
    name = "ClusteringPlugin"
    description = "Perform several Clustering algorithms in ManiVault"
    topics = ("hdps", "plugin", "data", "clustering")
    url = "https://github.com/ManiVaultStudio/ClusteringPlugin"
    ...
    scm = {
        "type": "git",
        "subfolder": "hdps/ClusteringPlugin",
        "url": "auto",
        "revision": "auto",
    }
    ...
    def _configure_cmake(self):
        cmake = CMake(self)
        cmake.configure(build_script_folder="hdps/ClusteringPlugin")
        cmake.verbose = True
        return cmake
